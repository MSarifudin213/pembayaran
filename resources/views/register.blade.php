@extends('layout')
@section('content')
<section class="vh-100 p-3" style="background-color: #eee;">
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Chat-App Register</p>
                ...
                @csrf <!-- {{ csrf_field() }} -->
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" name="password_confirm" class="form-control" required="" />
